...
function CleanerRobot(
    ...
    this.clean = () => {
        ...
        energy -= ENERGY_CONSUMPTION * cleaningTime;/*  к слову, неверное описание у переменной ENERGY_CONSUMPTION исходя из ожидаемого ответа 45.5. 
                                                    *   Не 1% батареи в час, а 1 условная единица батареи в час. Это вводит в заблуждение, т.к. с вашим описанием формула должна быть такой:
                                                    *   energy -= energy * 0.01 * ENERGY_CONSUMPTION * cleaningTime;
                                                    *   и ответ будет таким: 50 -= 50*0.01*1*4.5 = 47.75
        */
